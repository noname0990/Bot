...
client.on('messageCreate', msg => { 
  ...
  client.on('messageCreate', msg => {
    ...
    const replies = {
        'sa': 'aleyküm selam canım la naber 😋',
        'naber': 'iyi senden naber 😃',
        'sea': 'aleyküm selam canım la naber 😋',
        'selam': 'aleyküm selam canım la naber 😋',
        'selamun aleyküm': 'aleyküm selam canım la naber 😋',
        'selamunaleyküm': 'aleyküm selam canım la naber 😋',
        'selamunaleykum': 'aleyküm selam canım la naber 😋'
    };
		if (replies[content]) {
